Esta tool realiza la ejecucion de la tool que quieras ejecutando como parametro una lista que tengas, el resultado crea un archivo con el nombre de la linea + herramienta .txt
